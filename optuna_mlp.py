...
##########################################################################################################
# load arguments
parser = argparse.ArgumentParser(description='Hyperparameter optimization for GC-MLP models')
...
parser.add_argument('--split_type', type=str, required=True, default='fair_min', help='type of split to be used')
