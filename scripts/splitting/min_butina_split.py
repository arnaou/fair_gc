...
# make a copy of the minimal training set
...
df_train, df_val, df_test = expand_subset(df_mg, df_train, n_train_to_add, method=split_type.split('_')[0], butina_cutoff=0.85, random_seed=42)
