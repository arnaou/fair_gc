...
def parse_args():
    ...
    parser.add_argument('--save_best_model', default=False, help='Save the best model')
...
def bootstrap_training(model, data_dict, args, device, params):
    """Implements bootstrap training for uncertainty estimation"""
    ...
    # Create directory for this dataset's bootstrap results
    base_dir = '/zhome/32/3/215274/jinlia/project/Adem'  # or wherever you have write permissions
    results_dir = os.path.join(base_dir, 'bootstrap_results', args.dataset_name)
...
def main():
    ...
    if args.save_best_model:
        torch.save(model.state_dict(), f'/zhome/32/3/215274/jinlia/project/Adem/data/results/{args.dataset_name}_best_model.pth')
    ...
    if args.save:
        results_dir = f'data/results/{args.dataset_name}_bootstrap'
